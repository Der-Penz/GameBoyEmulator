...
public class CPHLInstruction extends OpCode {

    public CPHLInstruction() {
        super(0xBE, "CP (HL)", 8);
    }
    ...
    public int execute(Registers registers, AddressSpace addressSpace, Alu alu, int[] args) {
        ...
        aluOperation.apply(registers.getFlags(), registers.getA(), addressSpace.readByte(registers.getHL()));
        return cycles;
    }
}
