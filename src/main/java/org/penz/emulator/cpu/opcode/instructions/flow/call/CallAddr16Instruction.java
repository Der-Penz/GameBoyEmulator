...
/**
 * Subroutine call to address specified by 16 bit immediate data
 */
@SuppressWarnings("unused")
public class CallAddr16Instruction extends OpCode {
    public CallAddr16Instruction() {
        super(0xCD, "CALL a16", 24, new DataType[]{DataType.a16});
    }
